          ...
          messages: [
            {
              ...
              content:
                [
                  ...
                  '  • Format each item as "Short title — due timeframe" when a timeframe is mentioned.',
                  '  • CRITICAL: If the transcript mentions ANY timeframe for an action (e.g., "labs in three months", "follow up in 6 months", "return in 2 weeks"), you MUST include that timeframe after the em dash.',
                  '    - Example: If the transcript says "labs in three months", output: "Lab draw — in three months"',
                  '    - Example: If the transcript says "return to clinic in six months", output: "Return to clinic — in six months"',
                  '    - Example: If the transcript says "follow up in about 2-3 weeks", output: "Clinic follow up — in about 2-3 weeks"',
                  '  • Keep the title to 2-4 words using standardized phrases:',
                  '        • "Clinic follow up" or "Return to clinic"',
                  '        • "Lab draw" or "Labs"',
                  '        • "Imaging appointment"',
                  '        • "Nurse visit"',
                  '        • "Blood pressure check"',
                  '        • "Medication review"',
                  '        • "Referral" (specify specialty if mentioned)',
                  '  • Only omit the timeframe if NO timing was mentioned in the transcript at all.',
                  '  • ALWAYS create an action item when the clinician orders or recommends: diagnostic tests, imaging, labs, monitoring devices, referrals, nurse visits, or follow-up appointments.',
                  ...
                  '  • If the visit explicitly defers to patient discretion (e.g., "call us if symptoms worsen"), create a "Contact clinic" task with the conditional phrasing.',
                  '',
                  'Education object:',
                  '  {',
                  '    "diagnoses": [',
