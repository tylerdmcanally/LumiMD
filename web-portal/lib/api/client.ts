...
function buildNetworkError(original: unknown): ApiError {
  if (
    ...
    (original as Error).name === 'AbortError'
  ) {
...
export const api = {
  ...
  visits: {
    ...
    create: (data: any) =>
      apiRequest<any>('/v1/visits', {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    update: (id: string, data: any) =>
      apiRequest<any>(`/v1/visits/${id}`, {
        method: 'PATCH',
        body: JSON.stringify(data),
      }),
    delete: (id: string) =>
    ...
    retry: (id: string) =>
      apiRequest<any>(`/v1/visits/${id}/retry`, {
        method: 'POST',
      }),
  },
  actions: {
    ...
    create: (data: any) =>
      apiRequest<any>('/v1/actions', {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    update: (id: string, data: any) =>
      apiRequest<any>(`/v1/actions/${id}`, {
        method: 'PATCH',
        body: JSON.stringify(data),
      }),
    delete: (id: string) =>
  ...
  medications: {
    ...
    create: (data: any) =>
      apiRequest<any>('/v1/meds', {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    update: (id: string, data: any) =>
      apiRequest<any>(`/v1/meds/${id}`, {
        method: 'PATCH',
        body: JSON.stringify(data),
      }),
    delete: (id: string) =>
  ...
  users: {
    getCurrent: () => apiRequest<any>('/v1/users/me'),
