        ...
        {calendarDays.map((day) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex min-h-[110px] min-w-0 flex-col rounded-xl border p-3 text-left transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/40',
