      ...
      try {
        await api.user.updateProfile({
          legalAssent: {
            ...
            source: 'signup_web_google',
            platform: 'web',
          },
        });
      } catch (legalErr) {
        console.warn('[care-sign-up] Failed to persist profile metadata:', legalErr);
      }
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      try {
        ...
        console.warn('[care-sign-up] Failed to persist legal assent metadata:', legalAssentError);
      }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background-subtle to-accent-warm-pale p-6">
      <div className="w-full max-w-md animate-fade-in-up">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-text-primary">Join as a Caregiver</h1>
        ...
        <Card variant="elevated" padding="lg" className="shadow-floating">
          <div className="space-y-6">
            ...
            <Button
              ...
              disabled={isGoogleLoading || isSubmitting || !acceptedTerms || !acceptedPrivacy}
