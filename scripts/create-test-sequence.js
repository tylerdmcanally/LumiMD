/**
 * Quick test script to create compressed medication sequence
 * Run with: node create-test-sequence.js
 */
...
const steps = [
    ...
    { day: 7, title: 'First BP Check', message: `Time to log your blood pressure to see how ${medName} is working.`, actionType: 'log_bp' },
    ...
    { day: 14, title: 'Two Week BP Check', message: `Let's log another blood pressure reading to track your progress on ${medName}.`, actionType: 'log_bp' },
...
async function run() {
    console.log('Creating compressed medication sequence for testing...\n');
    ...
    console.log('\n🚀 Done! Watch your app for nudges appearing every 30 seconds.');
    process.exit(0);
}
